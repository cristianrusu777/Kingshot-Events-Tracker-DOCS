...
This is the detailed companion to the [full change inventory](/updates/last-24h-change-inventory). It covers the entire 24-hour app change set, not only the visible responsive pass. Current render captures are listed in the [Screenshot Matrix](/updates/screenshot-matrix-2026-07-13).
...
Current captures are stored under `/images/current/2026-07-13/`; paths and use are recorded in the [Screenshot Matrix](/updates/screenshot-matrix-2026-07-13). Mermaid diagrams cover the responsive navigation, processor selection, console separation, command flow, analytics sharing, secure upload access, restore requests, and role/permission flows.
