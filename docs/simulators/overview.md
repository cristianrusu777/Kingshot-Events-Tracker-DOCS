...
Whether preparing for upcoming Bear Trap events or optimizing Hero Gear reforge steps, the simulator suite delivers data-driven insights and deterministic calculations.

---

## Core Simulator Suite

The strategy lab consists of three specialized modules:
...
### 3. Saved-Run Models
Every simulation run can be saved as a named snapshot, letting you compare gear configurations side-by-side or track damage progression across multiple Bear Trap events.
