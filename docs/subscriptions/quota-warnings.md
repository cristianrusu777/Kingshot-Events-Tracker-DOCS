...
Your **Subscription & Usage panel** shows a bar for each resource with how much of the limit you've used, a percentage, and a status. It's on the kingdom detail page (Kings), the [My Alliance](../how-to/my-alliance.md) page (Leaders and Co-Leaders), and everywhere for Supreme Admins.

![Usage panel showing warning and exceeded resources](../images/subs-usage-warning.png)

## The warning levels

Each resource has a status based on how full it is:

| Level | How full | What it means |
|---|---|---|
| **OK** | under 80% | Plenty of room. Nothing to do. |
| **Warning** | 80% or more | Getting close. A good time to tidy up or plan an upgrade. |
| **Critical** | 95% or more | Almost full. Act soon to avoid being blocked. |
| **Exceeded** | 100% (full) | You've hit the ceiling. You can't add more of this resource until you free some up or raise the limit. |

The panel shows banners for anything at Warning or above, so you're never surprised.
