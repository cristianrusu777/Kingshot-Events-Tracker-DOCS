...
export const sourceMechanismCatalog = [
  ...
  ...group("Simulations and Optimizations", "kingshot-events/lab/hero-gear.md", "src/frontend/appPages/simulators/heroGear/CombatContextControls.tsx; src/frontend/appPages/simulators/heroGear/HeroGearResults.tsx", [["SRC-211","total-stat priority protection","raw stat total","weighted useful value"],["SRC-212","account-context objective","Balanced for my account","stat source"],["SRC-215","reforge donor priority locks","profile priority locks","reforge donors","higher-priority"]]),
  ...group("Simulations and Optimizations", "kingshot-events/lab/game-data-reference.md", "src/domain/simulators/spend-optimizer/data/dataset-metadata.ts; src/domain/simulators/spend-optimizer/data/hero-gear-data.ts", [["SRC-213","spend optimizer dataset v1.0.1 and per-level costs","dataset version 1.0.1","575,320","zero-XP milestones"],["SRC-214","Mastery enhancement gates and zero-XP transitions","Mastery enhancement caps","Mastery Forging","level 200"]]),
  ...group("Simulations and Optimizations", "kingshot-events/lab/bear-trap.md", "src/domain/simulators/spend-optimizer/data/weight-presets.ts; src/domain/simulators/spend-optimizer/bear/bearFormationOptimizer.ts; src/domain/simulators/spend-optimizer/bear/bearAtomicInput.ts", [["SRC-216","Bear Trap rally-host preset weights and defensive reserves","Bear Trap Rally Damage","35% reserve","Ranged Strike"],["SRC-217","multi-scale formation refinement","multi-scale top-region refinement","geometrically","single-troop"],["SRC-218","troop-type scoped skill effects","resolves skill effects by troop type","Infantry","matching troop"]]),
  ...group("Simulations and Optimizations", "kingshot-events/lab/governor-gear.md", "src/domain/simulators/spend-optimizer/optimizationGoal.ts; src/frontend/appPages/simulators/SystemOptimizerPage.tsx", [["SRC-219","governor and charm four optimization goals","Maximum stats","Combat power","Balanced troops","My build"]]),
  ...group("Knowledge Hub", "kingshot-events/knowledge-hub/authoring-and-publication.md", "src/domain/knowledge/KnowledgeLimits.ts; src/domain/knowledge/KnowledgeBlocks.ts", [["SRC-220","knowledge revision block limits and storage quotas","2,000 blocks per revision","2 GB","warnings at 90% usage"],["SRC-221","knowledge formula normalization and tool widget","LaTeX formula normalization","Tool / Simulator Widget"]]),
  ...group("Simulations and Optimizations", "kingshot-events/lab/index.md", "src/frontend/styles/pages/simulators.css; src/frontend/components/ui/AmbientCanvas.tsx; src/frontend/appPages/simulators/GameEntityImage.tsx", [["SRC-222","simulator Cyber design system and ambient backdrop","Cyber design system","Ambient canvas backdrop","Compact battle cards"],["SRC-223","game entity asset resolution and category fallbacks","authentic game asset mapping","awakened Red tier gear","Structured fallback system"]]),
  ...group("Simulations and Optimizations", "kingshot-events/lab/ascension-path.md", "src/domain/simulators/ascension/engine.ts; src/domain/simulators/ascension/types.ts; src/domain/simulators/ascension/eventAdapter.ts; src/frontend/appPages/simulators/AscensionPathPage.tsx; src/frontend/appPages/simulators/AscensionForecastCharts.tsx; src/frontend/appPages/simulators/AscensionProjectedBuild.tsx", [["SRC-224","Ascension Path multi-system beam search and step alternatives","Ascension Engine version 1.3.0","bounded beam search","Alternative comparison"],["SRC-225","Ascension Path weak points and opportunity scoring","Weak point analysis","Opportunity score","Healthy"],["SRC-226","Ascension Path event session timing recommendations","event sessions","UPGRADE NOW","NO TIMING ADVANTAGE"],["SRC-227","Ascension Path interactive forecast charts","forecast workbench","Combat Stats Trajectory","Resource Depletion Curves"],["SRC-228","Ascension Path resource routing workbench and offer ROI","Resource Routing","virtual shop","Analyze route"]]),
  ...group("Simulations and Optimizations", "kingshot-events/lab/championship-warboard.md", "src/domain/simulators/registry.ts; src/frontend/appPages/simulators/championship/ChampionshipWarboardPage.tsx; src/domain/simulators/championship-warboard", [["SRC-229","Championship Warboard public workflow","Championship Warboard","four-step","three-lane"],["SRC-230","Warboard partial opponent intelligence","Exact opponent AC is optional","likely range","confidence"],["SRC-231","Warboard browser-local persistence and exports","browser-local","Discord","CSV"],["SRC-232","Warboard blind Round 1 planning","Round 1","blind plan","not confirmed participants"]]),
